...
main.cpp
  ...
  ├── beep_player         - application-owned BeepPlayer: non-blocking PWM output
  │                         and pure beep_pattern math; no filesystem dependency
